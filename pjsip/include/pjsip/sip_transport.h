 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_register_type(unsigned tp_flag,
                              const char *tp_name,
                              int def_port,
                              int *p_tp_type);
 ...
 */
PJ_DECL(const char *)
pjsip_transport_get_type_name(pjsip_transport_type_e t);
 ...
 */
PJ_DECL(void)
pjsip_tpselector_add_ref(pjsip_tpselector *sel);
 ...
 */
PJ_DECL(void)
pjsip_tpselector_dec_ref(pjsip_tpselector *sel);
 ...
 */
PJ_DECL(char *)
pjsip_rx_data_get_info(pjsip_rx_data *rdata);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_rx_data_clone(const pjsip_rx_data *src,
                    unsigned flags,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tx_data_create(pjsip_tpmgr *mgr,
                     pjsip_tx_data **tdata);
 ...
 */
PJ_DECL(void)
pjsip_tx_data_add_ref(pjsip_tx_data *tdata);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tx_data_dec_ref(pjsip_tx_data *tdata);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tx_data_encode(pjsip_tx_data *tdata);
 ...
 */
PJ_DECL(pj_bool_t)
pjsip_tx_data_is_valid(pjsip_tx_data *tdata);
 ...
 */
PJ_DECL(void)
pjsip_tx_data_invalidate_msg(pjsip_tx_data *tdata);
 ...
 */
PJ_DECL(char *)
pjsip_tx_data_get_info(pjsip_tx_data *tdata);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tx_data_set_transport(pjsip_tx_data *tdata,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tx_data_clone(const pjsip_tx_data *src,
                    unsigned flags,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_register(pjsip_tpmgr *mgr,
                         pjsip_transport *tp);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_shutdown(pjsip_transport *tp);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_shutdown2(pjsip_transport *tp,
                          pj_bool_t force);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_destroy(pjsip_transport *tp);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_add_ref(pjsip_transport *tp);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_dec_ref(pjsip_transport *tp);
 ...
 */
PJ_DECL(pj_ssize_t)
pjsip_tpmgr_receive_packet(pjsip_tpmgr *mgr,
                           pjsip_rx_data *rdata);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_unregister_tpfactory(pjsip_tpmgr *mgr,
                                 pjsip_tpfactory *tpf);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_create(pj_pool_t *pool,
                   pjsip_endpoint *endpt,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_find_local_addr(pjsip_tpmgr *tpmgr,
                            pj_pool_t *pool,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_find_local_addr2(pjsip_tpmgr *tpmgr,
                             pj_pool_t *pool,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_destroy(pjsip_tpmgr *mgr);
 ...
 */
PJ_DECL(void)
pjsip_tpmgr_dump_transports(pjsip_tpmgr *mgr);
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_acquire_transport(pjsip_tpmgr *mgr,
                              pjsip_transport_type_e type,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_transport_send(pjsip_transport *tr,
                     pjsip_tx_data *tdata,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_send_raw(pjsip_tpmgr *mgr,
                     pjsip_transport_type_e tp_type,
                     const pjsip_tpselector *sel,
                     pjsip_tx_data *tdata,
                     const void *raw_data,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_set_state_cb(pjsip_tpmgr *mgr,
 ...
 */
PJ_DECL(pj_status_t)
pjsip_tpmgr_set_drop_data_cb(pjsip_tpmgr *mgr,
