 ...
 */
PJ_DECL(void)
pjsua_logging_config_dup(pj_pool_t *pool,
 ...
 */
typedef pj_status_t (*pjsua_med_tp_state_cb)(pjsua_call_id call_id,
...
{
    /**
     * Type of callback to receive new buffers
     *
     * @param buffer	Buffer
 ...
 */
PJ_DECL(void)
pjsua_config_dup(pj_pool_t *pool,
                 pjsua_config *dst,
...
pjsua_msg_data_clone(pj_pool_t *pool,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_init(const pjsua_config *ua_cfg,
 ...
 */
PJ_DECL(int)
pjsua_handle_events(unsigned msec_timeout);
 ...
 */
PJ_DECL(pj_pool_t *)
pjsua_pool_create(const char *name, pj_size_t init_size,
                  pj_size_t increment);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_reconfigure_logging(const pjsua_logging_config *c);
 ...
 */
PJ_DECL(pjsip_endpoint *)
pjsua_get_pjsip_endpt(void);
 ...
 */
PJ_DECL(pjmedia_endpt *)
pjsua_get_pjmedia_endpt(void);
 ...
 */
PJ_DECL(pj_pool_factory *)
pjsua_get_pool_factory(void);
 ...
 */
PJ_DECL(void)
pjsua_ip_change_param_default(pjsua_ip_change_param *param);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_update_stun_servers(unsigned count, pj_str_t srv[],
                          pj_bool_t wait);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_resolve_stun_servers(unsigned count,
                           pj_str_t srv[],
                           pj_bool_t wait,
                           void *token,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_cancel_stun_resolution(void *token,
                             pj_bool_t notify_cb);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_verify_sip_url(const char *url);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_verify_url(const char *url);
...
PJ_DECL(pj_status_t)
pjsua_schedule_timer_dbg(pj_timer_entry *entry,
                         const pj_time_val *delay,
                         const char *src_file,
                         int src_line);
#else
PJ_DECL(pj_status_t)
pjsua_schedule_timer(pj_timer_entry *entry,
                     const pj_time_val *delay);
#endif
...
PJ_DECL(pj_status_t)
pjsua_schedule_timer2_dbg(void (*cb)(void *user_data),
                          void *user_data,
                          unsigned msec_delay,
                          const char *src_file,
                          int src_line);
#else
PJ_DECL(pj_status_t)
pjsua_schedule_timer2(void (*cb)(void *user_data),
                      void *user_data,
                      unsigned msec_delay);
#endif
 ...
 */
PJ_DECL(void)
pjsua_perror(const char *sender, const char *title,
             pj_status_t status);
 ...
 */
PJ_DECL(void)
pjsua_transport_config_dup(pj_pool_t *pool,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_transport_register(pjsip_transport *tp,
                         pjsua_transport_id *p_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_tpfactory_register(pjsip_tpfactory *tf,
                         pjsua_transport_id *p_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_enum_transports(pjsua_transport_id id[],
                      unsigned *count);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_transport_get_info(pjsua_transport_id id,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_transport_set_enable(pjsua_transport_id id,
                           pj_bool_t enabled);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_transport_close(pjsua_transport_id id,
                      pj_bool_t force);
 ...
 */
PJ_DECL(void)
pjsua_ice_config_from_media_config(pj_pool_t *pool,
 ...
 */
PJ_DECL(void)
pjsua_ice_config_dup(pj_pool_t *pool,
                     pjsua_ice_config *dst,
 ...
 */
PJ_DECL(void)
pjsua_turn_config_from_media_config(pj_pool_t *pool,
 ...
 */
PJ_DECL(void)
pjsua_turn_config_dup(pj_pool_t *pool,
                      pjsua_turn_config *dst,
 ...
 */
PJ_DECL(void)
pjsua_srtp_opt_default(pjsua_srtp_opt *cfg);
 ...
 */
PJ_DECL(void)
pjsua_acc_config_dup(pj_pool_t *pool,
 ...
 */
PJ_DECL(pj_bool_t)
pjsua_acc_is_valid(pjsua_acc_id acc_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_set_default(pjsua_acc_id acc_id);
 ...
 */
PJ_DECL(pjsua_acc_id)
pjsua_acc_get_default(void);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_add(const pjsua_acc_config *acc_cfg,
              pj_bool_t is_default,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_add_local(pjsua_transport_id tid,
                    pj_bool_t is_default,
                    pjsua_acc_id *p_acc_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_set_user_data(pjsua_acc_id acc_id,
                        void *user_data);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_del(pjsua_acc_id acc_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_get_config(pjsua_acc_id acc_id,
                     pj_pool_t *pool,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_modify(pjsua_acc_id acc_id,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_set_online_status(pjsua_acc_id acc_id,
                            pj_bool_t is_online);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_set_online_status2(pjsua_acc_id acc_id,
                             pj_bool_t is_online,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_set_registration(pjsua_acc_id acc_id,
                           pj_bool_t renew);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_get_info(pjsua_acc_id acc_id,
                   pjsua_acc_info *info);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_enum_accs(pjsua_acc_id ids[],
                unsigned *count);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_enum_info(pjsua_acc_info info[],
                    unsigned *count);
 ...
 */
PJ_DECL(pjsua_acc_id)
pjsua_acc_find_for_outgoing(const pj_str_t *url);
 ...
 */
PJ_DECL(pjsua_acc_id)
pjsua_acc_find_for_incoming(pjsip_rx_data *rdata);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_create_request(pjsua_acc_id acc_id,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_create_uac_contact(pj_pool_t *pool,
                             pj_str_t *contact,
                             pjsua_acc_id acc_id,
                             const pj_str_t *uri);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_create_uas_contact(pj_pool_t *pool,
                             pj_str_t *contact,
                             pjsua_acc_id acc_id,
                             pjsip_rx_data *rdata);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_acc_set_transport(pjsua_acc_id acc_id,
...
typedef enum pjsua_call_vid_strm_op
{
    ...
    // attach flutter texture to stream
    PJSUA_CALL_VID_DECODING_STRM_ATTACH_TEXTURE
 ...
 *			media has not been established or is not active.
 */
PJ_DECL(pjsua_vid_win_id)
pjsua_call_get_vid_win(pjsua_call_id call_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_call_dump(pjsua_call_id call_id,
 ...
 */
PJ_DECL(int)
pjsua_call_get_vid_stream_idx(pjsua_call_id call_id);
 ...
 */
PJ_DECL(pj_bool_t)
pjsua_call_vid_stream_is_running(pjsua_call_id call_id,
                                 int med_idx,
                                 pjmedia_dir dir);
 ...
 */
PJ_DECL(pj_bool_t)
pjsua_buddy_is_valid(pjsua_buddy_id buddy_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_enum_buddies(pjsua_buddy_id ids[],
                   unsigned *count);
 ...
 */
PJ_DECL(pjsua_buddy_id)
pjsua_buddy_find(const pj_str_t *uri);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_buddy_get_info(pjsua_buddy_id buddy_id,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_buddy_set_user_data(pjsua_buddy_id buddy_id,
                          void *user_data);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_buddy_del(pjsua_buddy_id buddy_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_buddy_subscribe_pres(pjsua_buddy_id buddy_id,
                           pj_bool_t subscribe);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_pres_notify(pjsua_acc_id acc_id,
                  pjsua_srv_pres *srv_pres,
                  pjsip_evsub_state state,
 ...
 */
PJ_DECL(void)
pjsua_pres_dump(pj_bool_t verbose);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_im_send(pjsua_acc_id acc_id,
              const pj_str_t *to,
              const pj_str_t *mime_type,
              const pj_str_t *content,
              const pjsua_msg_data *msg_data,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_im_typing(pjsua_acc_id acc_id,
                const pj_str_t *to,
                pj_bool_t is_typing,
                const pjsua_msg_data *msg_data);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_conf_remove_port(pjsua_conf_port_id port_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_get_snd_dev2(pjsua_snd_dev_param *snd_param);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_set_snd_dev2(const pjsua_snd_dev_param *snd_param);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_dev_get_info(pjmedia_vid_dev_index id,
 ...
 */
PJ_DECL(pj_bool_t)
pjsua_vid_dev_is_active(pjmedia_vid_dev_index id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_dev_set_setting(pjmedia_vid_dev_index id,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_dev_get_setting(pjmedia_vid_dev_index id,
                          pjmedia_vid_dev_cap cap,
                          void *pval);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_enum_devs(pjmedia_vid_dev_info info[],
                    unsigned *count);
 ...
 */
PJ_DECL(void)
pjsua_vid_preview_param_default(pjsua_vid_preview_param *p);
 ...
 */
PJ_DECL(pj_bool_t)
pjsua_vid_preview_has_native(pjmedia_vid_dev_index id);
 ...
 */
PJ_DECL(pjsua_vid_win_id)
pjsua_vid_preview_get_win(pjmedia_vid_dev_index id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_preview_stop(pjmedia_vid_dev_index id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_enum_wins(pjsua_vid_win_id wids[],
                    unsigned *count);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_win_get_info(pjsua_vid_win_id wid,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_win_set_show(pjsua_vid_win_id wid,
                       pj_bool_t show);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_win_set_pos(pjsua_vid_win_id wid,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_win_set_size(pjsua_vid_win_id wid,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_win_set_win(pjsua_vid_win_id wid,
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_win_rotate(pjsua_vid_win_id wid,
                     int angle);
...
PJ_DECL(pj_status_t)
pjsua_vid_win_set_flutter_texture(
    pjsua_vid_win_id wid,
    pj_uint64_t texture_id);
/*
 * Video codecs API
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_enum_codecs(pjsua_codec_info id[],
                      unsigned *count);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_codec_set_priority(const pj_str_t *codec_id,
                             pj_uint8_t priority);
 ...
 */
PJ_DECL(unsigned)
pjsua_vid_conf_get_active_ports(void);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_conf_enum_ports(pjsua_conf_port_id id[],
                          unsigned *count);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_conf_add_port(pj_pool_t *pool,
                        pjmedia_port *port,
                        const void *param,
                        pjsua_conf_port_id *p_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_conf_remove_port(pjsua_conf_port_id port_id);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_conf_connect(pjsua_conf_port_id source,
                       pjsua_conf_port_id sink,
                       const void *param);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_conf_disconnect(pjsua_conf_port_id source,
                          pjsua_conf_port_id sink);
 ...
 */
PJ_DECL(pj_status_t)
pjsua_vid_conf_update_port(pjsua_conf_port_id port_id);
