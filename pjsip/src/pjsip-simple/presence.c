 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_init_module(pjsip_endpoint *endpt,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_create_uac(pjsip_dialog *dlg,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_create_uas(pjsip_dialog *dlg,
                      const pjsip_evsub_user *user_cb,
                      pjsip_rx_data *rdata,
                      pjsip_evsub **p_evsub)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_terminate(pjsip_evsub *sub,
                     pj_bool_t notify)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_initiate(pjsip_evsub *sub,
                    pj_uint32_t expires,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_add_header(pjsip_evsub *sub,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_accept(pjsip_evsub *sub,
                  pjsip_rx_data *rdata,
                  int st_code,
                  const pjsip_hdr *hdr_list)
{
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_get_status(pjsip_evsub *sub,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_set_status(pjsip_evsub *sub,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_notify(pjsip_evsub *sub,
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_current_notify(pjsip_evsub *sub,
                          pjsip_tx_data **p_tdata)
{
    pjsip_pres *pres;
    pjsip_tx_data *tdata;
 ...
 */
PJ_DEF(pj_status_t)
pjsip_pres_send_request(pjsip_evsub *sub,
                        pjsip_tx_data *tdata)
{
